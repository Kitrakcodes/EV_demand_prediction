...
for i in range(1, forecast_horizon + 1):
    ...
    numeric_date = (forecast_date - pd.Timestamp("2015-01-01")) // pd.Timedelta(days=30)
    cumulative_value = cumulative_ev[-1]
    ...
    'cumulative_ev': cumulative_value,
    ...
    X = pd.DataFrame([new_row])[model.feature_names_in_]
...
if multi_counties:
    ...
    for cty in multi_counties:
        ...
        for i in range(1, forecast_horizon + 1):
            ...
            new_row = {
            'year': forecast_date.year  # or whatever your forecast year is
            }
...
st.markdown("Prepared by **KARTIK DOGRA_INTERNSHIP_1748923002683e727a876ea** for the **AICTE Internship Cycle 2 by S4F**")